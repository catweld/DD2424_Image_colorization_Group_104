...
import numpy as np
import dataobjects
from Network_Layers import evaluate_model, get_callback_functions, train_pretrained_model, train_network
import data_manager
...
def main():
    ...
    # loaded_model = data_manager.load_model("trained_models/2020_05_16_08_24", settings, w)
    loaded_model = data_manager.load_model("trained_models/2020_05_17_09_30", settings, w)
