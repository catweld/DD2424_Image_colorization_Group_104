...
class settings:
    ...
    def __init__(self, nr_colors_space):
        ...
        self.nr_epochs = 75
        self.training_steps_per_epoch = 1714  # Nr dogs training images after split = 12348/7 = 1764
        self.validation_steps_per_epoch = 114  # Nr dogs validation images after split = 6174/7 = 882
        self.batch_size = 7
        ...
        self.data_directory = "dataset/all_data/"
